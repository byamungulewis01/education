                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered1 modal-simple modal-add-new-cc">
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <form method="POST" class="row g-3" action="{{ route('admin.training.store') }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="category_id" id="category" class="form-select" readonly required>
                    ...
                    <tbody>
                        @foreach ($trainings as $item)
                            <tr>
                                ...
                                <td>
                                    @if ($item->students() == 0)
                                        <a href="{{ route('admin.training.students', $item->id) }}">{{ $item->students() }}
                                            Student </a>
                                    @elseif($item->students() == 1)
                                        <a href="{{ route('admin.training.students', $item->id) }}">{{ $item->students() }}
                                            Student</a>
                                    @else
                                        <a href="{{ route('admin.training.students', $item->id) }}">
                                            {{ $item->students() }} Students</a>
                                    @endif
                                </td>
