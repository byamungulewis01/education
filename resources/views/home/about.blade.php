...
<!-- Offcanvas Start -->
<div class="offcanvas offcanvas-end offcanvas-mobile" id="offcanvasMobileMenu" style="background-image: url({{ asset('frontend/images/mobile-bg.jpg') }});">
    <div class="offcanvas-header bg-white">
        <div class="offcanvas-logo">
            <a class="offcanvas-logo__logo" href="#"><img src="{{ asset('frontend/images/dark-logo.png') }}" alt="Logo"></a>
        </div>
                        ...
                        <li>
                            ...
                            <div class="mega-menu-content">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="menu-content-banner" style="background-image: url({{ asset('frontend/images/home-megamenu-bg.jpg') }});">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div class="counter-item-03">
                        ...
                        <div class="counter-item-03__content">
                            <span class="counter-item-03__count count" data-count="15">0</span>
                            <p class="counter-item-03__text">Years of Language Education Experience</p>
                        </div>
                    </div>
                    <!-- Counter Item End -->
                ...
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div class="counter-item-03">
                        ...
                        <div class="counter-item-03__content">
                            <span class="counter-item-03__count count" data-count="23085">0</span>
                            <p class="counter-item-03__text">Learners Enrolled in EduMall Courses</p>
                        </div>
                    </div>
                    <!-- Counter Item End -->
                ...
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div class="counter-item-03">
                        ...
                        <div class="counter-item-03__content">
                            <span class="counter-item-03__count count"  data-count="135">0</span>
                            <p class="counter-item-03__text">Qualified teachers and language experts</p>
                        </div>
                    </div>
                    <!-- Counter Item End -->
                ...
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div class="counter-item-03">
                        ...
                        <div class="counter-item-03__content">
                            <span class="counter-item-03__count"><span class="count" data-count="127">2500</span>+</span>
                            <p class="counter-item-03__text">Innovative Foreign Language Courses</p>
                        </div>
                    </div>
                    <!-- Counter Item End -->
        ...
        <div class="row g-6">
                ...
                <div class="academics-item text-center" data-aos="fade-up" data-aos-duration="1000">
                    <a href="#" class="academics-item__link">
                        <div class="academics-item__image">
                            <img src="{{ asset('frontend/images/academics/event-thumbnail-01.jpg') }}" alt="University" width="370" height="269">
                            <h3 class="academics-item__title">Who we are</h3>
                        </div>
                        <div class="academics-item__description">
                            <p>Lorem ipsum dolor sit amet, <strong>consectetuer adipiscing</strong> elit, sed diam nonummy ndisse suscipit sagittis leom dolor sit amet,</p>
                        </div>
                    </a>
                </div>
                <!-- Academics End -->
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="academics-item text-center" data-aos="fade-up" data-aos-duration="1000">
                    <a href="#" class="academics-item__link">
                        <div class="academics-item__image">
                            <img src="{{ asset('frontend/images/academics/event-thumbnail-02.jpg') }}" alt="University" width="370" height="269">
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="academics-item text-center" data-aos="fade-up" data-aos-duration="1000">
                    <a href="#" class="academics-item__link">
                        <div class="academics-item__image">
                            <img src="{{ asset('frontend/images/academics/event-thumbnail-03.jpg') }}" alt="University" width="370" height="269">
