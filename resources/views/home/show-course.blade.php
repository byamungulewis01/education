                ...
                <div class="col-lg-7 col-md-7">
                    <div class="ed_detail_wrap light">
                        ...
                        <div class="ed_header_caption">
                            <h2 class="ed_title">{{ $school->title }}</h2>
                            <ul>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="crs_grid shadow_none brd">
                                    ...
                                    <div class="crs_grid_caption">
                                        ...
                                        <div class="crs_title">
                                            <h4><a href="course-detail.html" class="crs_title_link">{{ $course->title }}</a>
                                            </h4>
                                        </div>
                                        <div class="crs_cates cl_3"><span>{{ $course->program->title }}</span></div>
                                        ...
                                        <div class="crs_flex">
                                                ...
                                                <div class="crs_price">
                                                    ...
                                                    @else
                                                        <h5><span class="currency">$</span><span
                                                                class="theme-cl">{{ $course->price }}</span></h5>
                                                    @endif
                                            ...
                                            <div class="crs_fl_last">
                                                <div class="crs_linkview"><a href="course-detail.html"
                                                        class="btn btn_view_detail theme-bg text-light">Enroll Now</a>
                                                </div>
                        ...
                        <div class="page-sidebar p-0">
                            ...
                            <div class="collapse" id="fltbox">
                                ...
                                <div class="sidebar-widgets p-4">
                                    <form method="post" action="{{ route('filter', encrypt($school->id)) }}">
                                     @csrf
                                        ...
                                        <div class="form-group">
                                            <div class="simple-input">
                                                <select id="cates" required name="program_id" class="form-control">
