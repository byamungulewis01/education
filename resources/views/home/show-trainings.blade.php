            ...
            <div class="card px-3">
                <div class="row">
                    <div class="col-lg-6 card-body border-end">
                        <h4 class="mb-2">{{ $training->title }}</h4>
                        <p class="mb-0">{{ $training->description }}</p>

                        <div class="col-md-4">
                            <div class="text-md-end">
                                <div class="my-2 my-md-4"><span class="text-primary">$ {{ $training->price }}</span></div>
                                ...
                                @else
                                    <button data-bs-toggle="modal" data-bs-target="#addModal"
                                        class="btn btn-sm btn-label-primary mt-md-3 waves-effect">Get
                                        training</button>
                                @endif
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <h5 class="me-3"><a href="javascript:void(0)"
                                                    class="text-body">{{ $module->name }}</a></h5>
                                            <p class="mb-0"><span
                                                    class="text-body">{{ implode(' ', array_slice(str_word_count($module->description, 2), 0, 9)) }}...</span>
                                            </p>
                                        </div>
