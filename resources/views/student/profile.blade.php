                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('admin.changeProfile') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12 mb-2">
                                        ...
                                        <input type="text" name="fname" class="form-control" value="{{ auth()->guard('student')->user()->fname }}" />
                                    </div>
                                    <div class="col-12 mb-2">
                                        <label>Last Name</label>
                                        <input type="text" name="lname" class="form-control" value="{{ auth()->guard('student')->user()->lname }}" />
                                    </div>
                                    <div class="col-12 mb-2">
                                        <label>Email</label>
